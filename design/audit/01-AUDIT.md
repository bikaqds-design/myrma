...
| ✅ UX-GLOBAL-009 (CLOSED 2026-09-17) | All | Loading is a spinner (24 files) far more often than a skeleton (15) | Perceived perf | Medium | M | Skeletons matched to final layout on list/detail routes | per module |
