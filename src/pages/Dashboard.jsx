        ...
        {on('stat_tickets') && (
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden">
            <div className="px-6 pt-5 pb-3 flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-gray-900 dark:text-slate-100">Ticket Status</h2>
            </div>
            <div className="flex divide-x divide-gray-100 dark:divide-slate-700 border-t border-gray-100 dark:border-slate-700 overflow-x-auto">
              {[
