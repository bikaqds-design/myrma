...
function StatusBadge({ status }) {
  const colors = {
    ...
    'In Progress': 'bg-amber-100 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400',
    Pending: 'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400',
    Resolved: 'bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400',
    Closed: 'bg-gray-100 dark:bg-[#1a2230] text-gray-700 dark:text-[#9aa4b2]',
    Cancelled: 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400',
  }
  return (
    <span
      className={`px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap ${colors[status] || 'bg-gray-100 dark:bg-[#1a2230] text-gray-700 dark:text-[#9aa4b2]'}`}
    >
      {status}
    </span>
  )
              ...
              <div className="divide-y divide-gray-100 -mx-2">
                {overdueList.slice(0, 10).map((t) => (
                  ...
                  >
                    ...
                    <span className="ml-3 flex-shrink-0 px-2 py-0.5 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded-full text-xs font-medium">
