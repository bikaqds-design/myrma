...
const SOURCE_BADGE = {
  ...
  deal:        'bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300',
        ...
        <div className="px-5 py-4">
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3 flex-wrap">
              <SearchInput value={search} onChange={setSearch} placeholder={t('activities.searchPlaceholder')} aria-label={t('activities.searchPlaceholder')} className="flex-1 max-w-md" />
              <button
                ...
                paginatedActivities.map((activity, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Row # */}
                      <td className="px-2 py-3 text-xs text-[#746f65] dark:text-[#a4acb7] font-mono">
                        {startIndex + idx + 1}
                      </td>
                      ...
                      <td className={`px-4 py-3 text-xs font-medium whitespace-nowrap ${isLogsTab ? 'text-emerald-600 dark:text-emerald-400' : dateColor}`}>
                        {dateStr
                          ...
                          : <span className="text-[#746f65] dark:text-[#a4acb7]">{t('activities.noDueDate')}</span>
                        }
                        {isActOverdue && (
                      ...
                      <td className="px-4 py-3">
                        {activity.type === 'approval' ? (
                          ...
                          isLogsTab ? (
                            ...
                            <span className="text-xs text-[#746f65] dark:text-[#a4acb7] italic whitespace-nowrap">
                          ...
                          canEdit ? (
                            ...
                            <span className="text-xs text-[#746f65] dark:text-[#a4acb7]">—</span>
                          )
                        ) : isRescheduling ? (
