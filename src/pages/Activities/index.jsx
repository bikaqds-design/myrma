                ...
                paginatedActivities.map((activity, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Row # */}
                      <td className="px-2 py-3 text-xs text-[#a09d99] dark:text-[#4a5568] font-mono">
                        {startIndex + idx + 1}
                      </td>
                      ...
                      <td className={`px-4 py-3 text-xs font-medium whitespace-nowrap ${isLogsTab ? 'text-emerald-600 dark:text-emerald-400' : dateColor}`}>
                        {dateStr
                          ...
                          : <span className="text-[#a09d99] dark:text-[#4a5568]">{t('activities.noDueDate')}</span>
                        }
                        {isActOverdue && (
                      ...
                      <td className="px-4 py-3">
                        {activity.type === 'approval' ? (
                          ...
                          isLogsTab ? (
                            ...
                            <span className="text-xs text-[#a09d99] dark:text-[#4a5568] italic whitespace-nowrap">
                          ...
                          canEdit ? (
                            ...
                            <span className="text-xs text-[#a09d99] dark:text-[#4a5568]">—</span>
                          )
                        ) : isRescheduling ? (
