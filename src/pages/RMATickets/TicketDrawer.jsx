      ...
      <div className="w-full">
        ...
        <div className="px-6 py-5 space-y-6 max-h-[72vh] overflow-y-auto">
          ...
          <div className="border-t border-gray-200 dark:border-[#212a38] pt-5">
            ...
            {resolutionLoading && <p className="text-xs text-gray-400 dark:text-[#a4acb7] italic">Loading…</p>}
            ...
            {!resolutionLoading && resolution && !resolutionEditing && (
              <div className="bg-gray-50 dark:bg-[#0f1520] rounded-xl p-4 space-y-2">
                ...
                <p className="text-[10px] text-gray-400 dark:text-[#a4acb7]">By {resolution.created_by} · {new Date(resolution.created_at).toLocaleDateString()}</p>
              </div>
            )}

            {/* Empty state */}
            {!resolutionLoading && !resolution && !resolutionEditing && (
              <p className="text-xs text-gray-400 dark:text-[#a4acb7] italic">{t('ticketDrawer.noResolution')}</p>
            )}
              ...
              <div className="space-y-3">
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 border border-gray-300 dark:border-[#212a38] rounded-lg text-sm bg-white dark:bg-[#0f1520] text-gray-900 dark:text-[#e8ebf0] placeholder-gray-400 dark:placeholder-[#a4acb7] font-mono"
                      />
                    </div>
                  </>
                )}
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 border border-gray-300 dark:border-[#212a38] rounded-lg text-sm bg-white dark:bg-[#0f1520] text-gray-900 dark:text-[#e8ebf0] placeholder-gray-400 dark:placeholder-[#a4acb7]"
                      />
                    </div>
                  </>
                )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-1.5 border border-gray-300 dark:border-[#212a38] rounded-lg text-sm bg-white dark:bg-[#0f1520] text-gray-900 dark:text-[#e8ebf0] placeholder-gray-400 dark:placeholder-[#a4acb7] resize-none"
                  />
                </div>
