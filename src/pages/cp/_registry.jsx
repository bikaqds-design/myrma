    ...
    features: [
      {
        id: 'system-setup',
        label: 'System Setup',
        labelKey: 'cp.systemSetupLabel',
        desc: 'Currency and costing, countries and phone rules, business identity, tax and fiscal year, document numbering',
        descKey: 'cp.systemSetupDesc',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
