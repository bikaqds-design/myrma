    ...
    try {
      ...
      if (savedConfig) {
        setConfig({
          ...
          sectionOrder: savedConfig.sectionOrder?.length
            ...
            <div className="space-y-2">
              {(config.sectionOrder || DEFAULT_SECTION_ORDER).map((key, idx, arr) => {
                ...
                return (
                  <div
                    key={key}
                    className={`flex items-center gap-3 p-3 rounded-lg border transition-colors ${config.sections[key] ? 'bg-gray-50 border-gray-200' : 'bg-white border-gray-100 opacity-50'}`}
                  >
                ...
                {config.headerStyle !== 'none' && (
                  ...
                  >
                        ...
                        {config.showCompanyName && (
                          <div
                            style={{
                              fontWeight: 'bold',
                              color: previewColor,
                              fontSize: `${previewFontSize * 0.8}px`,
                            }}
                          >
                            Company Name
                          </div>
                        )}
                        <div style={{ fontWeight: '600', fontSize: `${previewFontSize * 0.75}px` }}>
                          RMA Ticket
                        </div>
                        {config.showRmaNumber && (
                          <div
                            style={{ color: '#6B7280', fontSize: `${previewFontSize * 0.65}px` }}
                          >
                            RMA-18052026-0001
                          </div>
                        )}
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                      {config.showDate && (
                        <div style={{ fontSize: `${previewFontSize * 0.6}px`, color: '#6B7280' }}>
                          18/05/2026
                        </div>
                      )}
                      {config.showLogo && logoUrl && config.logoPosition === 'right' && (
                        <img
                          src={logoUrl}
                          alt="logo"
                          style={{ height: '24px', objectFit: 'contain', marginLeft: '6px' }}
                        />
                      )}
                    </div>
                  </div>
                    ...
                    <div style={{ marginBottom: '8px' }}>
                      ...
                      >
                        {['Customer', 'Assigned To', 'Due Date'].map((l) => (
                          <div key={l}>
                            <div
                              style={{ fontSize: `${previewFontSize * 0.55}px`, color: '#9CA3AF' }}
                            >
                              {l}
                            </div>
                            <div
                              style={{
                                fontSize: `${previewFontSize * 0.65}px`,
                                background: '#F3F4F6',
                                borderRadius: '2px',
                                height: '5px',
                                marginTop: '2px',
                        ...
                        <div key={l} style={{ flex: 1 }}>
                          <div
                            style={{
                              ...
                              paddingTop: '3px',
                              fontSize: `${previewFontSize * 0.55}px`,
                              color: '#6B7280',
                            }}
                          >
                            {l}
