      ...
      >
        ...
        {canCreate && (
          <div ref={newMenuRef} className="relative">
            ...
            {newMenuOpen && (
              <div role="menu" className="absolute end-0 mt-1 w-48 z-30 bg-white dark:bg-[#121823] rounded-xl shadow-lg border border-[#e6e9ef] dark:border-[#212a38] py-1">
        ...
        <div className="px-5 py-4">
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3 flex-wrap">
              <SearchInput value={search} onChange={setSearch} placeholder={t('salesDocuments.searchPlaceholder')} aria-label={t('salesDocuments.searchPlaceholder')} className="flex-1 max-w-md" />
              <button
