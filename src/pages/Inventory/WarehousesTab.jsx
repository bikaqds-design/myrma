                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 border-r border-gray-100 text-center">
                      <span
                        className={`px-2 py-0.5 rounded text-xs font-semibold ${cnt > 0 ? 'bg-indigo-100 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-400' : 'bg-gray-100 dark:bg-[#1a2230] text-gray-500 dark:text-[#9aa4b2]'}`}
                      >
                        {cnt}
                      </span>
                    </td>
                    <td className="px-4 py-2.5 border-r border-gray-100 text-center">
                      <span
                        className={`px-2 py-0.5 rounded text-[10px] font-medium ${wh.is_active ? 'bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400' : 'bg-gray-100 dark:bg-[#1a2230] text-gray-500 dark:text-[#9aa4b2]'}`}
                      >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {!wh.isSystem && wh.is_active === false && (
                <span className="px-2 py-0.5 rounded text-[10px] font-medium bg-gray-100 dark:bg-[#1a2230] text-gray-500 dark:text-[#9aa4b2]">
                  Inactive
                </span>
              )}
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-1.5 text-center border-r border-gray-100">
                        {tk?.ticket_status ? (
                          <span
                            className={`px-1.5 py-0.5 rounded text-[10px] font-medium ${TICKET_STATUS_CLS[tk.ticket_status] || 'bg-gray-100 dark:bg-[#1a2230] text-gray-500 dark:text-[#9aa4b2]'}`}
                          >
                            {tk.ticket_status}
                          </span>
                        ) : (
