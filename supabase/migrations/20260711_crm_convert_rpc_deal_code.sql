-- 20260711_crm_convert_rpc_deal_code.sql
-- Update crm_convert_lead RPC to include deal_code (QT- prefix) in the
-- deals INSERT. Previously the deal was created without a code and had to
-- be patched client-side after conversion — this makes it atomic.
