...
WITH manifest(ord, tbl) AS (
  VALUES
    ...
    (36, 'ticket_activity'),
    (37, 'ticket_parts'),
    (38, 'ticket_resolutions'),
    (39, 'time_entries'),
    (40, 'purchase_orders'),
    (41, 'vendor_invoices'),
    (42, 'vendor_invoice_charges'),
    (43, 'vendor_payments'),
    (44, 'vendor_payment_applications'),
    (45, 'manufacturer_batches'),
    (46, 'inventory_units'),
    (47, 'warehouse_stock'),
    (48, 'stock_moves'),
    (49, 'quotations'),
    ...
    (52, 'invoices'),
    (53, 'payments'),
    (54, 'payment_applications'),
    (55, 'credit_notes'),
    (56, 'credit_note_applications'),
    (57, 'activities'),
    (58, 'notifications'),
    (59, 'user_activity_log'),
